...
/*
 * Created by jingbiaozhen on 2018/4/22.
 **/
public class RandomCodeView extends View
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        mTextSize = (int) ((float) mWidth / 3.5);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        // 文字位于正中间的坐标
        // float y = mHeight / 2 + (Math.abs(fontMetrics.ascent) -
    ...
    /**
     * getRandomY 获取文字Y坐标位置，y为文字baseline坐标 从 ascent到height-descent之间随机
     *
     * @param fontMetrics
     * @param height
     * @return float
